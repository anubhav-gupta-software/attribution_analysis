...
class RobertaModel:
    def __init__(self, model_name='roberta-base', model_dir='models/roberta'):
...
if __name__ == "__main__":
    if os.path.exists('data/processed/train.pkl'):
        ...
        # Taking a tiny slice to test pipeline
        test_run = True
        if test_run:
        ...
        roberta.train(train_df, val_df, epochs=1) # 1 epoch for test
    else:
        print("Please run data_utils.py first to generate data splits")
